...
int main(void)
{
  person p = person("John Doe","no address","912435678"); // create a new object and then copy it to p
  person q("no name","no address","no phone");           // create a new object (no copy needed)
